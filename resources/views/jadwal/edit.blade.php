...
<div class="p-4 lg:p-6 max-w-3xl mx-auto animate-fadeIn">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold mt-2">
            <span class="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Edit Jadwal</span>
        </h1>
    </div>
        ...
        <form method="POST" action="{{ route('jadwal.update', $jadwal) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="kode_matkul" value="{{ old('kode_matkul', $jadwal->kode_matkul) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nama_matkul" value="{{ old('nama_matkul', $jadwal->nama_matkul) }}" required
                        class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200">
                ...
                <div>
                    ...
                    <input type="text" name="kelas" value="{{ old('kelas', $jadwal->kelas) }}" required
                        class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200">
                ...
                <div>
                    ...
                    <input type="number" name="sks" min="1" max="6" value="{{ old('sks', $jadwal->sks) }}" required
                        class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200">
                ...
                <div>
                    ...
                    <input type="text" name="dosen" value="{{ old('dosen', $jadwal->dosen) }}" required
                        class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200">
            ...
            <div class="mt-4">
                ...
                <textarea name="keterangan" rows="3"
                    class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200">{{ old('keterangan', $jadwal->keterangan) }}</textarea>
